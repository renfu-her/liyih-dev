...
<!-- MOBILE SPECIFIC -->
	...
	<meta name="description" content="<?PHP
												$news_content = $rows_main["goods_item_description_en"];
	...
	<meta property="og:title" content="<?=$rows_main["goods_item_title_en"]; ?>-<?=$rows["conpany_en"];?>"/>
    ...
    <title><?=$rows_main["goods_item_title_en"]; ?>-<?=$rows["conpany_en"];?></title>
  ...
  <nav class="breadcrumb-row mb-md-5" aria-label="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="products.html">Product Description</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="products.php?class=<?=$rows_main["goods_class_no"]; ?>"><?=$rows_main["goods_class_name_en"]; ?></a>
      </ol>   
    </div>
  </nav>
 <!-- Content Section -->
        ...
        <div class="col-12 mb-5 py-3">
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-6 col-12">
                 <h2 class="font-weight-bold"><?=$rows_main["goods_item_title_en"]; ?></h2>
                <h5><?=$rows_main["goods_item_description_en"]; ?></h5>
                <div class="py-md-5 py-3">
                  <a href="contact.html#contactus" class="btn btn-send px-5 py-2"><h5 class="font-weight-bold mb-0 px-5">Consult now</h5></a>
                </div>
              </div>
            </div> 
          </div>
          ...
          <div class="container">
            <div class="row">
               <div class="col-12"  id="img-responsive">
                <!-- 編輯器 -->
               <?=$rows_main["goods_item_content_en"]; ?>
                <!-- 編輯器 -->
              </div>
            </div>
          </div>
