...
<?PHP include 'menu.php';?> 
  <header class="page-kv" style="background-image: url('../img/img_contactkv.jpg');">
    <div class="kv-caption">
      <h3 class="font-weight-bold text-white text-shadow mb-0">Contact Us</h3>
    </div>
  </header>
              ...
              <ul class="list-unstyled">
                <li class="p-2" data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-delay="700" data-aos-duration="1000" data-aos-anchor=".content">
                  <div class="d-flex flex-row align-items-center">
                    ...
                    <h5 class="d-inline-block align-middle mb-0 pl-2 text-white">Mon-Fri 8am-6pm</h5>  
                  </div>
                </li>
                <li class="p-2" data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-delay="800" data-aos-duration="1000" data-aos-anchor=".content">
                  <div class="d-flex flex-row align-items-center">
                    ...
                    <a href="tel:02-2201-4458" class="text-white"><h5 class="d-inline-block align-middle pl-2 mb-0 text-white">(02)2201-4458</h5></a>  
                  </div>
                </li>
                ...
                <li class="p-2" data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-delay="1000" data-aos-duration="1000" data-aos-anchor=".content">
                  <div class="d-flex flex-row align-items-start">
                    ...
                    <a href="https://goo.gl/maps/3EmoDoaVACzQFfN99" class="text-white" target="_blank"><h5 class="d-inline-block align-middle mb-0 pl-2 text-white">No.180, Min’an E. Rd., Xinzhuang Dist., New Taipei City 24266, Taiwan</h5></a>
                  </div>
                </li>
              </ul>
            </div>
    ...
    <div class="container-fluid pt-md-5" style="background-color: #f6f7f7;">
      <div class="row justify-content-center">
        <div class="col-12 py-5" id="form-anchor">
          <h3 class="page-title text-center mb-4" id="contactus">Fill Out The Form</h3>
          <p class="text-lightdark text-center mb-4">Please fill in the following information, we will have someone to contact you.</p>
            ...
            <div class="row">
              <div class="col-md-8 col-12 mx-auto">
                <form class="contactform needs-validation"  action="send_contact.php" method="post" >
                  ...
                  <div class="form-group">
                    <label for="contact_email" required>Email</label>
                    <input type="email" class="form-control form-control-lg" id="contact_email" name="contact_email" required>
                  </div>
                  <div class="form-group">
                    <label for="contact_objects" required>Inquiry Item</label>
                    <select class="form-control form-control-lg" id="contact_objects" name="contact_objects" required>
                      ...
                      <option value="Cooperation Meeting">Cooperation Meeting</option>
                      <option value="Wholesale Consulting">Wholesale Consulting</option>                      
                      <option value="Other">Other</option>
                    </select>
                  </div>
                  <div class="form-group">
                    <label for="contact_message">Content</label>
                  ...
                  <button type="submit" class="btn btn-send btn-block py-md-3 py-2" value="Submit"><h3>send out</h3></button>
