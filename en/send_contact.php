...
//mail發送
	...
	//$mail->SMTPDebug = 3; // 開啟偵錯模式
		...
		*/
		...
		if(!$mail->send()) {
			...
			echo "alert('Failed to send, please contact us!');";
			echo "location='./';";
			echo "</script>";
		} else {
			echo "<Script Language =\"Javascript\">";
			echo "alert('Information has been sent successfully, we will make contact with you as soon as possible, thank you!');";
			echo "location='./';";
			echo "</script>";	
		}
	    //mail發送
	...
	echo '<script language="javascript">';
	echo 'alert("Please tick I am not a robot");';
	echo "history.back();";
	echo '</script>';
	exit();
}
