...
<!-- MOBILE SPECIFIC -->
	...
	<meta name="description" content="<?PHP
												$abouts_content = $rows_main["abouts_content_en"];
	...
	<meta property="og:title" content="<?=$rows_main["abouts_name_en"].'-'.$rows["conpany"];?>"/>
    ...
    <title><?=$rows_main["abouts_name_en"].'-'.$rows["conpany_en"];?></title>
  <!-- Bootstrap core CSS -->
...
<?PHP include 'menu.php';?>  
  ...
  <header class="page-kv" style="background-image: url('../img/img_aboutkv.jpg');">
    <div class="kv-caption">
      <h3 class="font-weight-bold text-white text-shadow mb-0">Company</h3>
    </div>
  </header>
  ...
  <nav class="breadcrumb-row mb-md-5" aria-label="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="about.php">Company</a></li>
        <li class="breadcrumb-item active" aria-current="page"><?=$rows_main["abouts_name_en"]?></li>
      </ol>   
    </div>
  </nav>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 mb-md-0 mb-3">
          <h3 class="brand-title"><?=$rows_main["abouts_name_en"]?></h3>

          <div class="row">
            <div class="col-12 mb-md-0 mb-4 pr-3"  id="img-responsive">

 					<?PHP					
					echo $rows_main["abouts_content_en"];
					?>
