...
<!-- MOBILE SPECIFIC -->
	...
	<meta property="og:title" content="<?=$rows_main["goods_class_name_en"].'-'.$rows["conpany_en"];?>"/>
    ...
    <title><?=$rows_main["goods_class_name_en"].'-'.$rows["conpany_en"];?></title>
...
<?PHP include 'menu.php';?>  
  ...
  <header class="page-kv" style="background-image: url('../img/img_productkv.jpg');">
    <div class="kv-caption">
      <h3 class="font-weight-bold text-white text-shadow mb-0">Product Description</h3>
    </div>
  </header>
  ...
  <nav class="breadcrumb-row mb-md-5" aria-label="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="products.php">Product Description</a></li>
        <li class="breadcrumb-item active" aria-current="page"><?=$rows_main["goods_class_name_en"];?></li>
      </ol>   
    </div>
  </nav>
          ...
          <div class="container">
            <div class="d-flex flex-md-row flex-column justify-content-md-between justify-content-center align-items-md-center align-items-between w-100">
              <div class="p-title-block">
                <h2 class="p-title">Quality certification and recognition assurance</h2>
                <h3 class="p-subtitle">LIYIH PLASTICS CO., LTD is a trustworthy partner, our products are regularly sent to third-party certification agencies for inspection and to make consumers feel safe and assured.</h3>
              </div>
                ...
                <div class="card border-0 p-0">
                  <div class="card-img">
                    <a href="product_detail.php?no=<?=$rows_main["goods_item_no"];?>" class="hover-img">
                      <img class="card-img-top" src="../admin/goods_pic/<?=$rows_main["goods_item_pic_s"]; ?>" alt="product 01" style="aspect-ratio: 500/330">
                    </a>
                  </div>
                  <div class="card-body px-0">
                    <a href="product_detail.php?no=<?=$rows_main["goods_item_no"];?>" target="_blank">
                      <h4 class="text-dark"><?=$rows_main["goods_item_title_en"]; ?></h4>
                    </a>
                  </div>
                </div>
              </div>
