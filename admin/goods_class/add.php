...
<div class="box-header txt_12"><span>|| 後台管理介面 > 新增商品分類</span>
...
<div class="text-center txt_title"><strong>新增商品分類</strong></div>
<div class="box-body">
	<div class="form-group">
       ...
       <div class="form-group">
   		<label class="col-md-2 control-label">分類名稱(Title)：</label>
    	<div class="col-md-10">       
    	<input name="name_en"  id="name_en" type="text"  value=""  required="required" data-error="請填寫分類名稱(Title)" />
    	<div class="help-block with-errors"></div>
   	 	</div>
     </div>	     
        <div class="form-group">
