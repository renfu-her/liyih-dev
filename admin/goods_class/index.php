...
?>				  
                  ...
                  <tr>
                    ...
                    <td height="25" align="left" nowrap bgcolor="#FFFFFF" class="txt_12_gl" style="text-indent:0px;overflow:hidden;text-overflow:ellipsis;"><span class="text_item" style="text-indent:5px;">
                      
						<?=$rows["goods_class_name"]; ?></br>
                        <?=$rows["goods_class_name_en"]; ?>
