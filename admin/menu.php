...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">       
        ...
        <li <?PHP if($_SESSION['admin_menu_bt']==1) echo ' class="active"';?>>
          <a href="/admin/banner/index.php?menu_bt=1">
        ...
        <li <?PHP if($_SESSION['admin_menu_bt']==4) echo ' class="active"';?>>
          <a href="/admin/abouts/index.php?menu_bt=4&clean=yes">
            <i class="fa fa-cog fa-fw"></i> <span>公司簡介</span>
          </a>
        </li>  
        <li <?PHP if($_SESSION['admin_menu_bt']==5) echo ' class="active"';?>>
          <a href="/admin/news/index.php?menu_bt=5&clean=yes">
            <i class="fa fa-cog fa-fw"></i> <span>訊息公告管理</span>
          </a>
        </li>       
        <li <?PHP if($_SESSION['admin_menu_bt']==6) echo ' class="active"';?>>
          <a href="/admin/goods_class/index.php?menu_bt=6&clean=yes">
            <i class="fa fa-cog fa-fw"></i> <span>商品分類</span>
          </a>
        </li> 
         <li <?PHP if($_SESSION['admin_menu_bt']==7) echo ' class="active"';?>>
          <a href="/admin/goods_item/index.php?menu_bt=7&clean=yes">
            <i class="fa fa-cog fa-fw"></i> <span>商品管理</span>
          </a>
        </li> 
        <li <?PHP if($_SESSION['admin_menu_bt']==8) echo ' class="active"';?>>
          <a href="/admin/download/index.php?menu_bt=8&clean=yes">
            <i class="fa fa-cog fa-fw"></i> <span>檔案下載管理</span>
          </a>
        </li> 
