...
<div class="box-header txt_12"><span>|| 後台管理介面 > 新增訊息公告</span><span class="txt_12_red"></span>
</div><form  class="form-horizontal" name="form1" method="post" action="ind_unboxing_add_ok.php" id="form" data-toggle="validator"  enctype="multipart/form-data">
<div class="text-center txt_title"><strong>新增訊息公告</strong></div>
<div class="box-body">
     ...
     <div class="form-group">
    	...
    	<div class="col-md-10">       
    	<input name="title_en"  id="title_en" type="text"  value=""  required="required" data-error="必須填寫標題(Title)" />
    	<div class="help-block with-errors"></div>
   	 	</div>
     </div>	
     <div class="form-group">
     ...
     <div class="form-group">
      ...
      <div class="form-group">
    	...
    	<div class="col-md-10"> 
    	 <textarea name="content_en" cols="5" id="content_en"></textarea>
   	 	</div>
     </div>
