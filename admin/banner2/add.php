...
<div class="box-header txt_12"><span>|| 後台管理介面 > 新增首頁輪播(English)</span>
...
<div class="text-center txt_title"><strong>新增首頁輪播(English)</strong></div>
<div class="box-body">
<div class="form-group">
   		<label class="col-md-2 control-label">標題：</label>
    	<div class="col-md-10">       
			<input name="banner2_title" id="banner2_title" type="text" value=""  data-error="" />
