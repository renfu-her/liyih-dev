...
?>			
                ...
                <tr>
                  ...
                  <td height="25" align="left" valign="middle" bgcolor="#FFFFFF" class="txt_12_gl"><img src="../goods_pic/<?=$rows["banner2_pic_s"]; ?>"  height="50" border="1" style=" border-color:#666666; border-style:solid;" onerror="this.src='../goods_pic/defpic.jpg'" ></td>
                  ...
                  <td height="25" align="center" valign="middle" nowrap="nowrap" bgcolor="#FFFFFF" class="txt_12_gl">                    
                    <input name="<?=$rows["banner2_no"];?>" type="text" id="<?=$rows["banner2_no"];?>"  value="<?=$rows["banner2_sort"];?>" class="input_sort">
				  </td>

                  <td height="25" align="center" valign="middle" nowrap="nowrap" bgcolor="#FFFFFF" class="txt_12_gl"><a href="edit.php?no=<?=$rows["banner2_no"];?>" class="a_movetop"><span class="label label-success"><i class="fa fa-edit"></i> 修改</span></a></td>

                  <td height="25" align="center" valign="middle"nowrap="nowrap" bgcolor="#FFFFFF" class="txt_12_gl">
                  
                  <span class="label label-danger a_movetop" onclick ="return del_<?=$no_id?>()"  ><i class="fa fa-trash"></i> 刪除</span>
                      <input id="link_<?=$no_id?>" type="hidden" value="del_ok.php?no=<?=$rows["banner2_no"];?>&bpic=<?=$rows["banner2_pic_b"]; ?>&spic=<?=$rows["banner2_pic_s"]; ?>&bpic_mob	=<?=$rows["banner2_pic_b_mob"]; ?>&spic_mob	=<?=$rows["banner2_pic_s_mob"]; ?>"  />
