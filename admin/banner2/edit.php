...
$sql="
SELECT * FROM `banner2` 
where banner2_no=:edit_no";//sql語法
...
<div class="box-header txt_12"><span>|| 後台管理介面 > 修改首頁輪播(English)</span>
...
<div class="text-center txt_title"><strong>修改首頁輪播(English)
  <input type="hidden" name="edit_no" value="<?=$edit_no?>">   </strong></div>
<div class="box-body">
<div class="form-group">
   		<label class="col-md-2 control-label">標題：</label>
    	<div class="col-md-10">       
			<input name="banner2_title" id="banner2_title" type="text" value="<?=$rows["banner2_title"]; ?>"  data-error="" />
	...
	<div class="form-group">
    	...
    	<img src="../goods_pic/<?=$rows["banner2_pic_s"]; ?>"  height="150" border="1" class="img_Fillet"  onerror="this.src='../goods_pic/defpic.jpg'" >
     ...
     <div class="form-group">
    	...
    	<label for="imgfile">
      	...
      	<!--預覽區塊-->    
			...
			<span class="txt_12_red">說明：建議上傳大小為1920 x 800 pix </span>
			<div class="help-block with-errors"></div>
   	 	</div>
     </div>	
    ...
    <div class="form-group">
    	...
    	<div class="col-md-10">       
			<input name="link" id="link" type="text" value="<?=$rows["banner2_link"]; ?>"  data-error="請填寫超連結,需包含http://或https://" placeholder="超連結須完整，包含http://或https://" />
			<div class="help-block with-errors"></div>
   	 	</div>
     </div>	
     <div class="form-group">
    	...
    	<div class="col-md-10">       
    	    <select name="banner2_href" id="banner2_href"  data-error="請選擇開啟模式"> 
    	        <option value="無超連結" <?PHP if($rows["banner2_href"]=='無超連結') echo ' selected="selected"';?>>無超連結</option> 				                
				<option value="當前視窗" <?PHP if($rows["banner2_href"]=='當前視窗') echo ' selected="selected"';?>>當前視窗</option>
				<option value="開啟新頁" <?PHP if($rows["banner2_href"]=='開啟新頁') echo ' selected="selected"';?>>開啟新頁</option>                        
		    </select>
    		<div class="help-block with-errors"></div>
   	 	</div>
     </div>	
     <div class="form-group">
    	...
    	<div class="col-md-10">    
    	 <label for="hide" style="cursor:pointer">
			<input name="hide" type="checkbox" id="hide" value="1" <?PHP if($rows["banner2_hide"]==1) echo 'checked'; ?> class="input_checkbox" ><span class="txt_12_gl1" style="position: relative; bottom: 7px;">勾選後將展示於前台</span>
		</label>
			<div class="help-block with-errors"></div>
   	 	</div>
     </div>	   
