...
$sh_name=$_SESSION["sh_name"];//
	if ($sh_name<>"")
		$sql_where_name= "&& (`goods_item_title` like '%$sh_name%' || `goods_item_title_en` like '%$sh_name%' || `goods_item_model` like '%$sh_name%')";	
	else 
		$sql_where_name= "";
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="1%" align="right" valign="middle" bgcolor="#CDCED1" class="txt_12_gl"><table width="80" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="18" align="right" valign="bottom" class="txt_12_gl" style="padding: 0px !important;">分類：</td>
                    </tr>
                  </table></td>
			...
			<table width="100%" cellpadding="1" cellspacing="1" class="table_01 stripe">
                ...
                <tbody>
                  ...
                  <tr>				  
                    ...
                    <th width="7%" align="center" bgcolor="#367FA9" class="txt_wt"><strong>分類</strong></th>
                    <th height="25" align="center" bgcolor="#367FA9" class="txt_wt">名稱</th>
                    <th width="6%" align="center" bgcolor="#367FA9" class="txt_wt">首頁</th>

                    <th width="6%" align="center" bgcolor="#367FA9" class="txt_wt">顯示</th>
                    <th width="6%" align="center" bgcolor="#367FA9" class="txt_wt">排序</th>
                    <th width="6%" align="center" bgcolor="#367FA9" class="txt_wt">多圖</th>
...
?>
                  ...
                  <tr>
                    ...
                    <td height="25" align="left" nowrap bgcolor="#FFFFFF" class="txt_12_gl" style="text-indent:0px;overflow:hidden;text-overflow:ellipsis;">
					  <?=$rows["goods_class_name"]; ?></td>
                    <td height="25" align="left" bgcolor="#FFFFFF" class="txt_12_gl" style="overflow:hidden;text-overflow:ellipsis;"><?=$rows["goods_item_title"]; ?></br><?=$rows["goods_item_title_en"]; ?>
                    </td>
                    <td height="25" align="center" bgcolor="#FFFFFF" class="txt_12_gl" style="overflow:hidden;text-overflow:ellipsis;">
	 				<?PHP
						if($rows["goods_item_home"]==0)
                    ...
                    <td height="25" align="center" nowrap="nowrap" bgcolor="#FFFFFF" class="txt_12_gl">
                      ...
                      <input name="<?=$rows["goods_item_no"];?>" type="text" id="<?=$rows["goods_item_no"];?>" style="width:40px;" value="<?=$rows["goods_item_sort"];?>">                    </td>
                       <td height="25" align="center" bgcolor="#FFFFFF" class="txt_12_gl">
                     <a href="uppics.php?no=<?=$rows["goods_item_no"];?>"  class="a_movetop"><span class="label label-info"><i class="fa fa-picture-o"></i>  管理</span></a>
	   </td>
