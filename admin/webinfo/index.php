...
<div class="box-body">
	<div class="form-group">
     ...
     <div class="form-group">
   		<label class="col-md-2 control-label">公司網站名稱(Web Name)：</label>
    	<div class="col-md-10">       
    	<input name="conpany_en" type="text" id="conpany_en" value="<?=$rows["conpany_en"]; ?>"  required="required" data-error="請填寫公司網站名稱(Web Name)" />
    	<div class="help-block with-errors"></div>
   	 	</div>
     </div>	
     <div class="form-group">
     ...
     <div class="form-group">
   		<label class="col-md-2 control-label">關鍵字(Keywords)：</label>
    	<div class="col-md-10">       
    	<textarea name="keywords_en" wrap="virtual" id="keywords_en" style="height:100px;"><?=$rows["keywords_en"]; ?></textarea>
        <DIV class="txt_12_gl1">說明：友好搜尋引擎最佳化SEO,每個關鍵字中間用,分隔,建議創10~20個關鍵字(範例:網頁設計,程式設計,網頁行銷)</DIV>
   	 	</div>
     </div>	
      <div class="form-group">
     ...
     <div class="form-group">
   		<label class="col-md-2 control-label">網站描述(Description)：</label>
    	<div class="col-md-10">       
    	 <textarea name="description_en" wrap="virtual" id="description_en"  style="height:100px;"><?=$rows["description_en"]; ?></textarea>
        <DIV class="txt_12_gl1" >說明：友好搜尋引擎最佳化SEO,網頁內容簡述,介紹公司及商品等簡單資訊,當網站分享於FB或Line等社群網站時所呈現的預設文字</DIV>
   	 	</div>
     </div>	
     <div class="form-group">
