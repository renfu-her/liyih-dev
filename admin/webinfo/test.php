  ...
  <tr>
    <td height="40" align="left" valign="top"><form name="form1" method="post" action="edit_ok.php">
      <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
          <td bgcolor="#FFFFFF"><table width="100%" cellpadding="1" cellspacing="1" class="table_01 stripe">
              <tbody>
                <tr>
                  <th height="25" colspan="2" align="center"  class="txt_20"><strong>網站基本資料設定</strong></th>
                </tr>
                <tr>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="1">
                <tr>
                  <td height="25" align="right" valign="top"><table width="110" height="25" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                ...
                <tr>
                  <td width="10%" rowspan="2" align="right" valign="top" class="txt_12_gl"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                ...
                <tr>
                  <td height="25" valign="top" bgcolor="#FFFFFF" class="txt_12_gl1" ><span class="txt_12_gl1">說明：</span>友好搜尋引擎最佳化SEO,每個關鍵字中間用,分隔,建議創10~20個關鍵字(範例:網頁設計,程式設計,網頁行銷)</td>
                </tr>
                <tr>
                  <td rowspan="2" align="right" valign="top"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                ...
                <tr>
                  <td height="25" valign="top" bgcolor="#FFFFFF" class="txt_12_gl1"><span class="txt_12_gl1" >說明：友好搜尋引擎最佳化SEO,網頁內容簡述,介紹公司及商品等簡</span>單資訊</td>
                </tr>
                <tr>
                  <td height="12" align="right" valign="top"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                ...
                <tr>
                  <td height="25" align="right" valign="top"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
                      <tr>
