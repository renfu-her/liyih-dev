...
<div class="box-header txt_12"><span>|| 後台管理介面 ></span>修改公司簡介
</div>
...
<div class="text-center txt_title"><strong>修改公司簡介
...
<div class="box-body">
	<div class="form-group">
     ...
     <div class="form-group">
    	...
    	<div class="col-md-10">       
    	<input name="name_en"  id="name_en" type="text"  value="<?=$rows["abouts_name_en"]; ?>"  required="required" data-error="請填寫標題(Title)" />
    	<div class="help-block with-errors"></div>
   	 	</div>
     </div>    
     <div class="form-group">
      ...
      <div class="form-group">
    	...
    	<div class="col-md-10">       
    	 <textarea name="content_en" wrap="virtual" id="content_en"  style="height:100px;"><?=$rows["abouts_content_en"]; ?></textarea>        
   	 	</div>
     </div>	
     <!--按鈕-->
     <div  >
