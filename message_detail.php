...
<!-- MOBILE SPECIFIC -->
	...
	<meta name="description" content="<?PHP
												$news_content = $rows_main["news_content"];
	...
	<meta property="og:title" content="<?=$rows_main["news_title"]; ?>-<?=$rows["conpany"];?>"/>
    ...
    <title><?=$rows_main["news_title"]; ?>-<?=$rows["conpany"];?></title>
...
<?PHP include 'menu.php';?>  
  ...
  <header class="page-kv" style="background-image: url('img/img_messagekv.jpg');">
    <div class="kv-caption">
      <h3 class="font-weight-bold text-white text-shadow mb-0">訊息公告</h3>
    </div>
  </header>
  ...
  <nav class="breadcrumb-row mb-md-5" aria-label="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">訊息公告</li>
      </ol>   
    </div>
  </nav>
      ...
      <div class="row">
        <div class="col-12 my-3">
          <div class="d-flex flex-md-row flex-column justify-content-md-between justify-content-center align-items-md-center align-items-between w-100">
            <h3 class="m-title"><?=$rows_main["news_title"]; ?></h3>
